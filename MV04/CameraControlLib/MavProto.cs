...
//using static MissionPlanner.MV04.CameraControlLib.MainForm;
using System.Linq.Expressions;
using System.Threading;
using System.Windows.Forms;

namespace MissionPlanner.MV04.CameraControlLib
{
    class MavProto
    {
        ...
        *                                                      MavProto()
        *                                                      
        * Description : MavProto Constructor for COM port interface
        * 
        * Arguments   : string port_name - COM port name
        *               int baud         - COM port baud rate
        *               mav_packet_received - callback for reports
        *               ackCb - callback for COMMAND_ACK messages
        *
        * Returns     : none
        * 
        ****************************************************************************************************************************/
        ...
        *                                                      MavProto()
        *                                                      
        * Description : MavProto Construction for Ethernet(IP) interface
        * 
        * Arguments   : IPAddress ip    - destination ip address, 
        ...
        *                                                              SetProtocolVer()
        *                                                      
        * Description : Sets mavlink protocol version
        * 
        * Arguments   : byte proto_ver - protocol version
        *
        * Returns     : none
        * 
        ****************************************************************************************************************************/
        ...
        *                                                              getProtocolVer()
        *                                                      
        * Description : Get the mavlink protocol version
        * 
        * Arguments   : none
        *
        * Returns     : none
        ...
        *                                                              SetMavProtoValuesByVersion()
        *                                                      
        * Description : Sets values according to mavlinks protocol version
        * 
        * Arguments   : none
        *
        * Returns     : none
        ...
        ****************************************************************************************************************************/
        ...
        /****************************************************************************************************************************
        *                                                              public MavProtoClose()
        *                                                      
        * Description : Release all sockets and interfaces that are used by the object
        * 
        * Arguments   : none
        *
        * Returns     : none
        ...
        ****************************************************************************************************************************/
        ...
        /****************************************************************************************************************************
        *                                                      DumpMavCmdCommandData()
        *                                                      
        * Description : Dumps command bytes of MavCmd* functions, without actually sending commands
        *               
        * Arguments   : Action command_callback - callback which wraps the call to a MavCmd* function
        *        
        * Returns     : none
        *
        ****************************************************************************************************************************/
        ...
        ****************************************************************************************************************************/
        /****************************************************************************************************************************
        *                                                      MavlinkSendAttitudeMsg()
        *                                                      
        * Description : Transmits the Mavlink Attitude Packet
        *               
        * Arguments   : float           roll - platform roll
        ...
        ****************************************************************************************************************************/
        ...
        /****************************************************************************************************************************
        *                                                      MavlinkSendGlobalPosIntMsg()
        *                                                      
        * Description : Transmits the Mavlink Global Position Int Packet
        *               
        * Arguments   : float            lat - platform latitude
        ...
        ****************************************************************************************************************************/
        ...
        /****************************************************************************************************************************
        *                                                      MavlinkSendGPSRawIntMsg()
        *                                                      
        * Description : Transmits the Mavlink GPS Raw Int Packet
        *               
        * Arguments   : int        sat_count - number of visable satelites
        *        
        * Returns     : none
        *
        ****************************************************************************************************************************/
        ...
        /****************************************************************************************************************************
        *                                                      MavlinkSendSysStatusMsg()
        *                                                      
        * Description : Transmits the Mavlink System Status Packet
        *               
        * Arguments   : float   batt_voltage - battery voltage
        *        
        * Returns     : none
        *
        ****************************************************************************************************************************/
        ...
        /****************************************************************************************************************************
        *                                                      MavlinkSendHeartbeatMsg()
        *                                                      
        * Description : Transmits the Mavlink Heartbeat Packet
        *               
        * Arguments   : bool     drone_armed - is the platfrom armed ( motors are running, ready to takeoff )
        *        
        * Returns     : none
        *
        ****************************************************************************************************************************/
        ...
        /****************************************************************************************************************************
        *                                                      MavlinkSendSysTimeMsg()
        *                                                      
        * Description : Transmits the Mavlink System Time Packet
        *               
        * Arguments   : int  epoch_timestamp - timestamp in epoch
        *        
        * Returns     : none
        *
        ****************************************************************************************************************************/
        ...
        /****************************************************************************************************************************
        *                                                      MavlinkSendMountControlMsg()
        *                                                      
        * Description : Transmits the Mavlink Command Long Message - Sub Command: DO_MOUNT_CONTROL
        *               
        * Arguments   : ref byte[]      tx_packet - will be filled with a the packet data
        *               MavMountMode    mount_mode - new mount mode
        *        
        * Returns     : none
        *
        ****************************************************************************************************************************/
        ...
        *
        * Description : Used to convert byte array report messages to structs
        *
        * Arguments   : byte[] bytearray  - input byte array
        *               ref object obj    - object to fill
        *               int startoffset   - starting offset
        *               int payloadlength - conversion size
        *
        * Returns     : none
        *
        ****************************************************************************************************************************/
        ...
        *
        * Arguments   : float angle - angle in degree
        *
        ...
        *
        * Arguments   : float angle - angle in radian
        *
